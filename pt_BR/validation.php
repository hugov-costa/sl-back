...
return [
    ...
    | classe validadora. Algumas dessas regras possuem múltiplas versões como
    ...
    */
    ...
    'ascii' => 'O campo :attribute deve conter apenas caracteres alfanuméricos single-byte e símbolos.',
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Atributos de Validação Personalizado
    |--------------------------------------------------------------------------
    |
    ...
    | de "email". Isso simplesmente nos ajuda a tornar nossas mensagens mais expressivas.
    |
    */
